...
public class CorsRoute {
  ...
  public CorsRoute(String allowedOriginPattern, Boolean allowCredentials, List<String> allowHeaders,
      List<HttpMethod> allowMethods, List<String> exposeHeaders, HttpMethod fromMethod, String fromPath) {
    super();
  ...
  public static CorsRoute from(JsonObject json) {
    ...
    HttpMethod fromMethod = HttpMethodUtils.from(json);
    String fromPath = json.getString("path");
